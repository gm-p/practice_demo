...
// Example30Dlg.cpp : 实现文件
//

#include "stdafx.h"
#include "Example30.h"
#include "Example30Dlg.h"
...
CExample30Dlg::CExample30Dlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CExample30Dlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CExample30Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_TAB1, m_tab);
}

BEGIN_MESSAGE_MAP(CExample30Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_NOTIFY(TCN_SELCHANGE, IDC_TAB1, &CExample30Dlg::OnTcnSelchangeTab1)
END_MESSAGE_MAP()


// CExample30Dlg 消息处理程序
...
void CExample30Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CExample30Dlg::OnQueryDragIcon()
{
...
void CExample30Dlg::OnTcnSelchangeTab1(NMHDR *pNMHDR, LRESULT *pResult)
{
	// TODO: 在此添加控件通知处理程序代码
	*pResult = 0;


	CRect tabRect;//标签控制客户区的Rect
