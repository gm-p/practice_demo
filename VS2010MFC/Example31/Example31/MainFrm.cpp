...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	//创建上面窗格中的视图
	if(!m_wndSplitter.CreateView(0,0,RUNTIME_CLASS(CExample31View),CSize(rc.Width(),rc.Height()/2),pContext))
		return FALSE;
	//创建下面窗格中的视图
	if(!m_wndSplitter.CreateView(1,0,RUNTIME_CLASS(CExample31View),CSize(rc.Width(),rc.Height()/2),pContext))
		return FALSE;
