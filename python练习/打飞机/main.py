...
def main():
    ...
    for i in range(BULLET1_NUM):
        bullet1.append(bullet1.Bullet1(me.rect.midtop))
    ...
    for i in range(BULLET2_NUM/2):
        bullet2.append(bullet1.Bullet2((me.rect.centerx-33, me.rect.centery)))
        bullet2.append(bullet1.Bullet2((me.rect.centerx+30, me.rect.centery)))
    ...
    #每30秒发放一个补给包
    bullet = supply.Bullet_Supply(bg_size)
    ...
    while running:
        for event in pygame.event.get():
            if event.type == QUIT:
                ...
                is_double_bullet = False
                pygametime.set_timer(DOUBLE_BULLET_TIME, 0)
            ...
            for each in big_enemies:
                if each.active:
                    ...
                    if energy_remain > 0.2:
                        ...
                        energy_color = RED
                    pygame.draw.line(screen, energy_color, (each.rect.left, rect.top - 5),\
