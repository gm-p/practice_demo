...
class SmallEnemy(pygame.sprite.Sprite):
    def __init__(self, bg_size):
        ...
        self.destroy_images = []
        self.destroy_images.extend([pygame.image.load("image/enemy1_down1.png").convert_alpha(),\
...
class MidEnemy(pygame.sprite.Sprite):
    ...
    def __init__(self, bg_size):
        ...
        self.image_hit = pygame.image.load("iamge/enemy2_hit.png").convert_alpha()
        self.destroy_images = []
        self.destroy_images.extend([pygame.image.load("image/enemy2_down1.png").convert_alpha(),\
...
class BigEnemy(pygame.sprite.Sprite):
    ...
    def __init__(self, bg_size):
        ...
        self.image_hit = pygame.image.load("iamge/enemy3_hit.png").convert_alpha()
        self.destroy_images = []
        self.destroy_images.extend([pygame.image.load("image/enemy3_down1.png").convert_alpha(),\
